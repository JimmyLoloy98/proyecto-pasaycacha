...
public class interfasLoginv4 extends JFrame implements ActionListener{
    ...
    private JMenu versiones;
    private JMenuItem version1;
    //
    //interfasPrincipal ventanaPrincipal;
    
    public interfasLoginv4(){
        this.setSize(400, 700);
        this.setTitle("HOTEL PASAYCACHA v-4.0");
